...
class DetailsParser(BaseParser):
    def parse_basic_info(self) -> Dict[str, str]:
        ...
        try:
            return {
                'id': self._extract_text('div.col-md-6:-soup-contains("Código de centro:") span'),
                'name': self._extract_text('div.col-md-6:-soup-contains("Denominación específica:") span'),
                'phone': self._extract_text('div.col-md-6:-soup-contains("Teléfono:") span'),
                'fax': self._extract_text('div.col-md-6:-soup-contains("Fax:") span'),
                'email': self._extract_text('div.col-md-6:-soup-contains("Correo electrónico:") span'),
                'website': self._extract_text('div.col-md-6:-soup-contains("Página Web del centro:") a')
            }
    ...
    def parse_location_info(self) -> Dict[str, str]:
        ...
        try:
            return {
                'autonomous_community': self._extract_text('div.col-md-6:-soup-contains("Autonomía:") span'),
                'province': self._extract_text('div.col-md-6:-soup-contains("Provincia:") span'),
                'country': self._extract_text('div.col-md-6:-soup-contains("País:") span'),
                'region': self._extract_text('div.col-md-6:-soup-contains("Comarca:") span'),
                'sub_region': self._extract_text('div.col-md-6:-soup-contains("Sub.Provincial / Isla:") span'),
                'municipality': self._extract_text('div.col-md-6:-soup-contains("Municipio:") span'),
                'locality': self._extract_text('div.col-md-6:-soup-contains("Localidad:") span'),
                'address': self._extract_text('div.col-md-6:-soup-contains("Domicilio:") span'),
                'postal_code': self._extract_text('div.col-md-6:-soup-contains("Código postal:") span')
            }
        except Exception as e:
    ...
    def parse_classification_info(self) -> Dict[str, str]:
        ...
        try:
            return {
                'nature': self._extract_text('div.col-md-6:-soup-contains("Naturaleza:") span'),
                'is_concerted': self._extract_text('div.col-md-6:-soup-contains("Concertado:") span'),
                'center_type': self._extract_text('div.col-md-6:-soup-contains("Tipo de centro:") span'),
                'generic_name': self._extract_text('div.col-md-6:-soup-contains("Denominación genérica:") span')
            }
        except Exception as e:
    ...
    def parse_services(self) -> List[str]:
        ...
        try:
            ...
            table = services_header.find_parent('div').find_next('table')
            if not table:
    ...
    def parse_imparted_studies(self) -> List[Dict[str, str]]:
        ...
        try:
            ...
            # Find the closest table after the header
            table = studies_header.find_parent('div').find_next('table')
            if not table:
    ...
    def parse_all(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not basic_info.get('id'):  # If we can't get the basic info, something is wrong
